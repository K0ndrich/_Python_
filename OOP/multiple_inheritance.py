...
# Mixin (Миксины) всегда прописываються в конце наследования для возможного переопредиления методов родительского класса A
# множественное наследование происходит слева на право, сначала наследуються атрибуты и методы класса A, а потом уже от Mixin
class B(A, Mixin):
    pass


my_object = B()
my_object.hello()  # -> Hello Max
