...
# -----   ПЕРЕДАЧА В ФУНКЦИЮ ИЗМЕНЯЕМОГО СПИСКА   ---------------------------------------------------------------------------------------------------------------------------------------------------


# внутрь функции пердаеться именно сылка на обьект список, а не новый список
# используеться один и тотже список
def my_fn1(my_list=[]):
