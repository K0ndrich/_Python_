...
# задача найти ключ, значение которого самое большое в словаре
...
# возвращате ключ словаря у которого самое большое значение
max(a)  # -> 3

# возвращате ключ словаря у которого самое большое значение, но только через лямбда функцию
max(a, key=lambda x: a[x])  # -> 3
